...
<head>
	...
	<title>@yield('mahasiswa_page_title')</title>
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					@if(Auth::user()->role == 2)  {{-- Sidebar untuk mahasiswa --}}
						<li class="sidebar-header">
							FAQ
						</li>
						...
						<li class="sidebar-item {{ request()->routeIs('mahasiswa.faq') ? 'active' : '' }}">
							<a class="sidebar-link" href="{{ route('mahasiswa.faq') }}">
								<i class="align-middle" data-feather="file-plus"></i> <span class="align-middle">FAQ</span>
							</a>
						</li>
						...
						<li class="sidebar-item {{ request()->routeIs('mahasiswa.jadwal') ? 'active' : '' }}">
							<a class="sidebar-link" href="{{ route('mahasiswa.jadwal') }}">
								<i class="align-middle" data-feather="clipboard"></i> <span class="align-middle">Jadwal</span>
							</a>
						</li>
						...
						{{-- <li class="sidebar-item {{ request()->routeIs('absen.create') ? 'active' : '' }}">
							<a class="sidebar-link" href="{{ route('absen.create') }}">
								<i class="align-middle" data-feather="clipboard"></i> <span class="align-middle">Mata Kuliah</span>
							</a>
						</li> --}}
